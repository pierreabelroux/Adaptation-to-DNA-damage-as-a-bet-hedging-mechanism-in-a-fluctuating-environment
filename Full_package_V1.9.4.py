...
def display_1d(x, y, option, xlab=None, ylab=None, title=None) :
    ...
    if option == 1 :
        ...
        if xlab == None :
            ax.set_xlabel("Value of p", fontsize=20)
        else :
            ax.set_xlabel(xlab, fontsize=20)
        if title != None :
            ax.set_title(title)
    ...
    if ylab == None :
        ax.set_ylabel("Saturation time $T_S$", fontsize=20)
    else :
...
if __name__ == "__main__" :
    ...
    # end = 7
    # nbr_param = 100
    # best_slope(start, end, nbr_param, mean_b=1.5, display=1, mean_a=MEAN_A, environment=0)
    # 
    # start_mean = 1
    # end_mean = 8
    # nbr_mean = 50
    ...
    # ax1.set_ylabel("Percentage of final healthy cells descending\n from adapted cells: stable environment", color=color, fontsize=20)
    # 
    ...
    # ax2.set_ylabel("Percentage of final healthy cells descending\n from adapted cells: random environment", color=color, fontsize=20)
